...
class VGG19:
    ...
    def train_model(self):
        # load data
        tr_data, va_data = self.data_loader()
        ...
        fit_his = model.fit(tr_data, steps_per_epoch=math.ceil(14034/self.batch_size), epochs=self.epochs, 
                                  verbose=self.verbose, validation_data=va_data, validation_steps=math.ceil(3000/self.batch_size))
